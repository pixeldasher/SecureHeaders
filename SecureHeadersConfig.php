            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'notes' => __("Beispiel für eine gute CSP: `default-src 'self' 'nonce-proxy' 'strict-dynamic'; style-src-attr 'unsafe-inline'; img-src 'self' data:; connect-src 'self'; form-action 'self'; upgrade-insecure-requests; block-all-mixed-content;`"),
                        'value' => "default-src 'self' 'nonce-proxy' 'strict-dynamic'; style-src-attr 'unsafe-inline'; img-src 'self' data:; connect-src 'self'; form-action 'self'; upgrade-insecure-requests; block-all-mixed-content;",
                        'rows' => 8,
                        'showIf' => 'csp_enabled=1',
                    ],
                    [
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'notes' => __('Beispiel, um den Zugriff auf gängige Features zu beschränken: `fullscreen=(), geolocation=(), camera=(), microphone=(), usb=()`'),
